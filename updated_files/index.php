        ...
        <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
          ...
          <div class="list-group" style="text-align: justify;">
            <div class="list-group-item">
              ...
              <p class="mb-1">  <a class="button button-hero mt-4" href="https://docs.fcc.gov/public/attachments/DOC-363498A1.pdf">Annoucements</a> &nbsp;&nbsp;&nbsp;<a class="button button-hero mt-4" href="#">Services We Offer</a></p>
            </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-xl-5 align-self-center  mb-lg-0">
          <div class="search-content">
            <h2>Call center services <br class="d-none d-xl-block"></h2>
            <div class="list-group" style="text-align: justify;">
              <div class="list-group-item">
                <p class="mb-1"><i class="fas fa-circle text-dark mx-2"></i>Telemedicine service platform and devices</p>
                <p class="mb-1"><i class="fas fa-circle text-dark mx-2"></i>  Call center service</p>
                <p class="mb-1"><i class="fas fa-circle text-dark mx-2"></i>Provider Network</p>
                <p class="mb-1"><i class="fas fa-circle text-dark mx-2"></i>Program Execution & Training</p>
                <p class="mb-1">  <a class="button button-hero mt-4" href="https://docs.fcc.gov/public/attachments/DOC-363498A1.pdf">Go To FCC Docs</a> &nbsp;&nbsp;&nbsp;<a class="button button-hero mt-4" href="#">Services We Offer</a></p>
              </div>
            </div>
          </div>
